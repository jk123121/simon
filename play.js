const btnDescriptions = [
  ...
  class Game 
  {
    ...
    constructor() 
    {
      ...
      {
        if (i < btnDescriptions.length) {this.buttons.set(el.id, new Button(btnDescriptions[i], el));}
      });
    ...
    getPlayerName() {return localStorage.getItem('userName') ?? 'Mystery player';}
    ...
    saveScore(score) 
    {
      ...
      if (scoresText) {scores = JSON.parse(scoresText);}
  ...
  function loadSound(filename) {return new Audio('assets/' + filename);}
